Pod::Spec.new do |spec|
  spec.name         = "NMSSH"
  spec.version      = "2.3.1.dac"
  spec.summary      = "NMSSH is a clean, easy-to-use, unit tested framework for iOS and OSX that wraps libssh2."
  spec.homepage     = "https://github.com/DachengWang/NMSSH"
  spec.license      = 'MIT'
  spec.authors      = { "Christoffer Lejdborg" => "hello@9muses.se", "Tommaso Madonia" => "tommaso@madonia.me", "Wang Dacheng" => "dachengxiaozhan.qq.com" }

  spec.source       = { :git => "https://github.com/DachengWang/NMSSH.git", :tag => spec.version.to_s }
